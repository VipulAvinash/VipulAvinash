...
|---|---|---|
| **[HRMS SaaS Platform](https://vwsync.com)** | Multi-tenant HR management platform — employee QR ID cards, GPS breadcrumb tracking for field staff, in-browser image editor for report uploads | React · Node.js · MongoDB · Leaflet.js |
| **Hire-IQ** | AI-powered interview platform with live proctoring, face detection, and automated scoring | React · FastAPI · Python |
| **AI Product Search Aggregator** | Search aggregator for Indian e-commerce, blending LLM querying with real Amazon.in / Flipkart results | React · Redis · MongoDB · LLM APIs |
| **DashCart** | E-commerce platform with full storefront and admin flows | MERN Stack |
| **Student Management System** | End-to-end student records and management system | MERN Stack |
| **FateChat** | Personal chat application project | MERN Stack |
